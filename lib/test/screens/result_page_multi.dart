...
import 'package:wellbeingclinic/test/screens/result_page_single.dart';
        ...
        body: Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 16),
              Text(
                '*এই পরীক্ষার ফলাফল ${extra.resultModels.length}টি। সব ফলাফল দেখতে ট্যাব চাপুন অথবা ডানে-বামে টানুন',

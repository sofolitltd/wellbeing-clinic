...
class MentalHealthExercisesPage extends StatelessWidget {
  MentalHealthExercisesPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          Colors.grey.shade50, // Light background for the whole page
      appBar: AppBar(
        title: const Text(
        ...
        backgroundColor: Colors.indigo.shade700, // Deep indigo AppBar
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildDetailedHorizontalCard(
  ...
  // --- Detailed Horizontal Card Widget (Now takes full available height) ---
  Widget _buildDetailedHorizontalCard({
    ...
    return Container(
      width: 270, // Slightly wider to accommodate full-height content well
      height: double.infinity, // <-- THIS IS THE KEY CHANGE!
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Text(
                    ...
                    maxLines:
                        3, // Allow more lines for description in a taller card
                    overflow: TextOverflow.ellipsis,
                  ),
                ),
              ],
